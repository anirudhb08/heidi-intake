...
class Medication(TypedDict):
    name: str  # exactly as the patient said it
    ...
    as_described: str  # what the patient said it is for or where it came from, when the name was not recognised; else ""
    ...
    async def lookup_medication(
        ...
        if canon is None:
            result = {
                ...
                "instruction": "Not on the clinic list. Do not ask the patient to spell it. Ask once what it is for and "
                               "who gave it to them, then record the name exactly as they said it with that description in "
                               "as_described. Do not suggest a different medication.",
            }
        else:
